...
function tinhdk_add_menus() {
	...
	// add_submenu_page(__FILE__,'TinhDk Donate','Tặng tác giả',8,'tinhdk_submenu_donate','tinhdk_submenu_donate');
}
...
function tinhdk_menu() { ?>
    ...
    <?php
    if ($_POST['update_options']=='true') {//lưu biến gửi biểu mẫu
    	...
    	tinhdk_up_or_del('tinhdk_QQ');
    	tinhdk_up_or_del('tinhdk_weibo');
    	tinhdk_up_or_del('tinhdk_zhihu');
    	tinhdk_up_or_del('tinhdk_beian');
		...
		echo '<div><p>Lưu thành công!</p></div>';//
	}
    ?>
...
function tinhdk_up_or_del($op) {
	...
	//Nếu giá trị rỗng, xoá dòng dữ liệu đó
